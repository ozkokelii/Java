...
public class Idman {
	...
	public void burpeeYap(int sayi) {
		...
		if(burpee_sayisi - sayi<0) {
			System.out.println("Hedeflediðiniz burpeeyi geçtiniz...");
			burpee_sayisi = 0;
	...
	public void pushupYap(int sayi) {
		...
		if(pushup_sayisi - sayi<0) {
			System.out.println("Hedeflediðiniz pushupi geçtiniz...");
			pushup_sayisi = 0;
	...
	public void situpYap(int sayi) {
		...
		if(situp_sayisi - sayi<0) {
			System.out.println("Hedeflediðiniz situpi geçtiniz...");
			situp_sayisi = 0;
	...
	public void squatYap(int sayi) {
		...
		if(squat_sayisi - sayi<0) {
			System.out.println("Hedeflediðiniz squati geçtiniz...");
			squat_sayisi = 0;
